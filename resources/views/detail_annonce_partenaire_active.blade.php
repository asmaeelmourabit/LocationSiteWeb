        ...
        <div class="row g-0">
            <div class="col-md-6 border-end">
             	<div class="d-flex flex-column justify-content-center">
                    ...
                    <a href="{{ url('') }}/home/ActiveAnnonceMeth/{$details->id}}/{{ auth()->user()->id }}" style="background-color:rgb(0,128,128);" class="btn btn-primary mt-5" >Active</a>    
                </div>
                ...
                <div class="mt-2 pr-3 content">
                   ...
                   <h6><i  class="fa fa-map-marker"> {{$details->ville}}</i></h6>
                    ...
                    <span>441 reviews</span>
                     ...
                     <p class="card-text">Posté le :{{$details->created_at}}</p>
                     </div>
                    </div>
